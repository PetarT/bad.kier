...
class ReditemViewCategoryDetail extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$fieldsModel->setState('filter.types', $category->type_id);
		...
		$itemsModel->setState('list.select', 'DISTINCT (i.id), i.title, i.publish_up, i.params, i.created_user_id, i.type_id');
