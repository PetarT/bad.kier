...
class JPagination
{
	...
	public function getPagesLinks()
	{
		...
		if ($data->start->base !== null)
		{
			...
			// is this prev?
			$this->_shOptions = array();
			if ($data->previous->base !== null && $data->previous->base == $data->start->base)
			{
				$this->_shOptions['rel'] = 'prev';
			}
		...
		if ($data->previous->base !== null)
		{
			...
			$this->_shOptions = array('rel' => 'prev');
		...
		foreach ($data->pages as $i => $page)
		{
			if ($page->base !== null)
			{
				...
				// is this next or prev?
				$this->_shOptions = array();
				if ($data->next->base !== null && $data->next->base == $page->base)
				{
					$this->_shOptions['rel'] = 'next';
				}
				else if ($data->previous->base !== null && $data->previous->base == $page->base)
				{
					$this->_shOptions['rel'] = 'prev';
				}
		...
		if ($data->next->base !== null)
		{
			...
			$this->_shOptions = array('rel' => 'next');
		...
		if ($data->end->base !== null)
		{
			...
			// is this next?
			$this->_shOptions = array();
			if ($data->next->base !== null && $data->next->base == $data->end->base)
			{
				$this->_shOptions['rel'] = 'next';
			}
	...
	public function getPaginationLinks($layoutId = 'joomla.pagination.links', $options = array())
	{
		...
		$list = array('prefix' => $this->prefix, 'limit' => $this->limit, 'limitstart' => $this->limitstart, 'total' => $this->total,
			'limitfield' => $this->getLimitBox(), 'pagescounter' => $this->getPagesCounter(), 'pages' => $this->getPaginationPages());
