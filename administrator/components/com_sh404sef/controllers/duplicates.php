	...
	public function makemainurl()
	{
		...
		if ($model = $this->getModel($this->_defaultModel, 'Sh404sefModel'))
		{
			...
			if (version_compare(JVERSION, '3.0', 'ge'))
			{
				...
				$failure = array('url' => 'index.php?option=com_sh404sef&c=duplicates&view=duplicates&tmpl=component',
					'message' => JText::sprintf('JERROR_SAVE_FAILED', $this->getError()));
				$success = array('url' => 'index.php?option=com_sh404sef&tmpl=component&c=duplicates&view=duplicates&layout=refresh',
