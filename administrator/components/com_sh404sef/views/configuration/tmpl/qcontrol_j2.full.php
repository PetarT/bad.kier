...
<table class="adminlist">
  ...
  <tr>
    <td class="qbutton" colspan="2">
       <a href="javascript: void(0);" onclick="shSubmitQuickControl()" ><span class="icon-48-save" title="<?php echo JText::_('COM_SH404SEF_SAVE'); ?>"></span><?php echo JText::_('COM_SH404SEF_SAVE'); ?></a>
    </td>
  </tr>
</table>
</td>
<td style="padding: 5px;text-align: justify;">
    <?php echo '<h3>' . JText::_('COM_SH404SEF_WELCOME') . '</h3>' . JText::_('COM_SH404SEF_QCONTROL'); ?>
</td>
</tr>
</table>
