...
if (!defined('_JEXEC')) die('Direct Access to this location is not allowed.');
	...
	if (!empty($this->analytics->analyticsData->topSocialTweeter)) : ?>

   <h2><?php echo JText::_('COM_SH404SEF_ANALYTICS_SOCIAL_TWEETER_ENGAGEMENT'); ?></h2>
    ...
    <thead>
      <tr>
        ...
        <th rel="tooltip" <?php echo Sh404sefHelperHtml::wrapBootstrapTipTitle(JText::_('COM_SH404SEF_ANALYTICS_TOTAL_TWEETER_ENGAGEMENT'), JText::_('COM_SH404SEF_ANALYTICS_TOTAL_TWEETER_ENGAGEMENT_DESC'));?>>
 	...
 	<?php else : ?>
 	  <h4 class="muted"><?php echo JText::_('COM_SH404SEF_ANALYTICS_SOCIAL_NO_TWEETER_ENGAGEMENT'); ?></h4>
 	<?php endif; ?>
