...
?>
  <?php if (!empty($this->analytics->analyticsData->topSocialFB)) : ?>
   ...
   <h2><?php echo JText::_('COM_SH404SEF_ANALYTICS_SOCIAL_FACEBOOK_ENGAGEMENT'); ?></h2>
    ...
    <thead>
      <tr>
        ...
        <th rel="tooltip" <?php echo Sh404sefHelperHtml::wrapBootstrapTipTitle(JText::_('COM_SH404SEF_ANALYTICS_TOTAL_FACEBOOK_ENGAGEMENT'), JText::_('COM_SH404SEF_ANALYTICS_TOTAL_FACEBOOK_ENGAGEMENT_DESC'));?>>
 	...
 	<?php else : ?>
 	  <h4 class="muted"><?php echo JText::_('COM_SH404SEF_ANALYTICS_SOCIAL_NO_FACEBOOK_ENGAGEMENT'); ?></h4>
 	<?php endif; ?>
