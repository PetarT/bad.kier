...
class JPagination extends JObject
{
	...
	protected function _item_active(&$item)
  {
    ...
    if ($app->isAdmin())
    {
      ...
      return "<a title=\"".$item->text."\" href=\"".$item->link. '"' .(Sh404sefFactory::getConfig()->insertPaginationTags && !empty($this->_shOptions['rel']) ? ' rel="' . $this->_shOptions['rel'] . '"' : ''). " class=\"pagenav\">".$item->text."</a>";
    }
  }
