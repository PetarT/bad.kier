...
class ReditemHelperHelper
{
	 ...
	 * Get rating tags
	 *
	 * @return  array list of rating tag
	 */
	public function getRatingTags()
	{
		$tags = array(
			"{item_rated}" => JText::_("COM_REDITEM_TEMPLATE_TAG_ITEM_RATED_POINTS"),
		);
	...
	{
		$commentTags = array(
			"{comment_id}"            => JText::_('COM_REDITEM_TEMPLATE_TAG_COMMENT_ID'),
			"{comment_comment}"       => JText::_('COM_REDITEM_TEMPLATE_TAG_COMMENT_COMMENT'),
			"{comment_createddate}"   => JText::_('COM_REDITEM_TEMPLATE_TAG_CREATED_DATE'),
			"{comment_user_username}" => JText::_('COM_REDITEM_TEMPLATE_TAG_COMMENT_USER_USERNAME'),
			"{comment_user_email}"    => JText::_('COM_REDITEM_TEMPLATE_TAG_COMMENT_USER_EMAIL'),
			"{comment_user_name}"     => JText::_('COM_REDITEM_TEMPLATE_TAG_COMMENT_USER_NAME'),
		);
	...
	public static function getCategoryTags($template, $subCategories = false)
	{
		...
		if (!$subCategories)
		{
			...
			$categoryTags[] = self::getItemTags($template->type_id, 'category');
	...
	public static function getItemTags($typeId = null, $context = 'item')
	{
		...
		$itemTags = array(
			...
			'{item_comments}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_COMMENT_LIST'),
			'{item_comment_form}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_COMMENT_FORM'),
			'{item_comment_info}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_COMMENT_INFO'),
			'{if_comments}' => JText::_('COM_REDITEM_TEMPLATE_TAG_IF_COMMENTS'),
			'{end_if_comments}' => JText::_('COM_REDITEM_TEMPLATE_TAG_END_IF_COMMENTS'),
			'{item_rating}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_RATING'),
			'{item_rating_info}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_RATING_INFO'),
			'{if_rating}' => JText::_('COM_REDITEM_TEMPLATE_TAG_IF_RATING'),
			'{end_if_rating}' => JText::_('COM_REDITEM_TEMPLATE_TAG_END_IF_RATING'),
			'{item_report}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_REPORT'),
			'{item_watching}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_WATCHING'),
			'{item_watching_info}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_WATCHING_INFO'),
			'{if_watched}' => JText::_('COM_REDITEM_TEMPLATE_TAG_IF_WATCHED'),
			'{end_if_watched}' => JText::_('COM_REDITEM_TEMPLATE_TAG_END_IF_WATCHED'),
			...
			'{if_cf|<em>fieldcode</em>}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_IF_CUSTOMFIELD'),
			'{if_cf_end}' => JText::_('COM_REDITEM_TEMPLATE_TAG_ITEM_IF_CUSTOMFIELD_END'),
		);
	...
	public static function getFilterTags()
	{
		$filterTags = array(
			...
			'{filter_rating}'
				=> JText::_('COM_REDITEM_TEMPLATE_TAG_FILTER_RATING'),
			'{save_filter}'
				=> JText::_('COM_REDITEM_TEMPLATE_TAG_SAVE_FILTER')
		);
