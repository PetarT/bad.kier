			...
			<div class="form-horizontal">
				<div class="control-group" style="margin-bottom: 0px;">
					<div class="control-label">
						<label for="<?php echo $fieldId; ?>_alt"><?php echo JText::_('COM_REDITEM_CUSTOMFIELD_IMAGE_ALT_TITLE');?></label>
					</div>
					<div class="controls">
						<input type="text" name="cform[alt][<?php echo $fieldcode; ?>]" id="<?php echo $fieldId; ?>_alt" value="<?php echo $alt; ?>"/>
					</div>
				</div>
			</div>
